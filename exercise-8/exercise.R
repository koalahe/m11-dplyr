...
setwd("/Users/conniehe/Desktop/m11-dplyr/exercise-8/data/")
# Read in the data
...
Pulitzer.Prize.Change <- mutate(pulitzer, diff.2004.2014.to.1990.2003 = Pulitzer.Prize.Winners.and.Finalists..2004.2014 - 
